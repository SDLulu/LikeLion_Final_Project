...
// 선글라스 패시브 아이템
// 📍 위치: PassiveItems 폴더
// 🎯 목적: 사용 시 특별한 효과 부여 (예: 시야 확장, 특수 능력 등)
public class Sunglasses : NetworkBehaviour, IItemInteraction
{
    [Header("Sunglasses Settings")]
    [SerializeField] private string itemName = "Sunglasses";
    ...
    public void OnUsePress(Vector2 mouseWorldPosition, Vector2 playerPosition)
    {
        ...
        if (playerInventory != null)
        {
            ...
            Debug.Log($"[Sunglasses] 플레이어 인벤토리에 선글라스 효과 적용됨");
        ...
        {
            Debug.LogError("[Sunglasses] PlayerInventory를 찾을 수 없습니다!");
        }
    ...
    public void OnPickedUp()
    {
        ...
        IsHeld = true;
        Debug.Log($"[Sunglasses] {itemName} 픽업됨");
    }
    ...
    private void RemoveFromHand()
    {
        ...
        if (playerThrower != null)
        {
            ...
            Debug.Log($"[Sunglasses] 기존 던지기 시스템으로 손에서 제거됨");
        }
        else
        {
            Debug.LogError("[Sunglasses] PlayerObjectThrower를 찾을 수 없습니다!");
        }
        
        // 물리 활성화는 상관없음 (어차피 바로 Despawn)
        Runner.Despawn(Object);
        Debug.Log($"[Sunglasses] {itemName} Despawn됨");
    }
