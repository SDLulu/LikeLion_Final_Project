...
// 이속신발 패시브 아이템
// 📍 위치: PassiveItems 폴더
// 🎯 목적: 사용 시 플레이어의 이동 속도 증가
public class SpeedShoes : NetworkBehaviour, IItemInteraction
{
    [Header("SpeedShoes Settings")]
    [SerializeField] private string itemName = "SpeedShoes";
    ...
    public void OnPickedUp()
    {
        ...
        IsHeld = true;
        Debug.Log($"[SpeedShoes] {itemName} 픽업됨");
    }
    ...
    public void OnReleased()
    {
        ...
        IsHeld = false;
        Debug.Log($"[SpeedShoes] {itemName} 해제됨");
    }
    ...
    private void RemoveFromHand()
    {
        ...
        if (playerThrower != null)
        {
            ...
            Debug.Log($"[SpeedShoes] 기존 던지기 시스템으로 손에서 제거됨");
        }
        else
        {
            Debug.LogError("[SpeedShoes] PlayerObjectThrower를 찾을 수 없습니다!");
        }
