...
//     version 1.13.1
//     from Assets/_TestSandBox/LMU/Settings/GameInputAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_TestSandBox/LMU/Settings/GameInputAction.inputactions".
/// </summary>
/// <remarks>
...
public partial class @GameInputAction: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                {
                    ""name"": ""ESC"",
                    ""type"": ""Button"",
                    ""id"": ""ba04b83e-40ee-40ee-ab21-06d42fa7ee3f"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Voice"",
                    ""type"": ""Button"",
                    ""id"": ""8ecdaa4b-56b1-43c7-a227-27ff7f4a53d1"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""eec02ff0-57eb-4f05-97e7-fc26b1426ed7"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0cf3d482-a88a-44ac-94d5-b433a340dd22"",
                    ""path"": ""<Keyboard>/m"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_Lobby_RightClick = m_Lobby.FindAction("RightClick", throwIfNotFound: true);
        m_Lobby_MiddleClick = m_Lobby.FindAction("MiddleClick", throwIfNotFound: true);
        m_Lobby_ScrollWheel = m_Lobby.FindAction("ScrollWheel", throwIfNotFound: true);
        m_Lobby_TrackedDevicePosition = m_Lobby.FindAction("TrackedDevicePosition", throwIfNotFound: true);
        m_Lobby_TrackedDeviceOrientation = m_Lobby.FindAction("TrackedDeviceOrientation", throwIfNotFound: true);
        // Game
        m_Game = asset.FindActionMap("Game", throwIfNotFound: true);
        m_Game_ESC = m_Game.FindAction("ESC", throwIfNotFound: true);
        m_Game_Voice = m_Game.FindAction("Voice", throwIfNotFound: true);
        // Shared
    ...
    ~@GameInputAction()
    {
        UnityEngine.Debug.Assert(!m_Lobby.enabled, "This will cause a leak and performance issues, GameInputAction.Lobby.Disable() has not been called.");
        ...
        UnityEngine.Debug.Assert(!m_Shared.enabled, "This will cause a leak and performance issues, GameInputAction.Shared.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Lobby_RightClick;
    private readonly InputAction m_Lobby_MiddleClick;
    private readonly InputAction m_Lobby_ScrollWheel;
    private readonly InputAction m_Lobby_TrackedDevicePosition;
    private readonly InputAction m_Lobby_TrackedDeviceOrientation;
    /// <summary>
    ...
    public struct LobbyActions
    {
        ...
        /// </summary>
        public LobbyActions(@GameInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Lobby/Navigate".
        /// </summary>
        public InputAction @Navigate => m_Wrapper.m_Lobby_Navigate;
        /// <summary>
        /// Provides access to the underlying input action "Lobby/Submit".
        /// </summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "Lobby/Point".
        /// </summary>
        public InputAction @Point => m_Wrapper.m_Lobby_Point;
        /// <summary>
        /// Provides access to the underlying input action "Lobby/Click".
        /// </summary>
        public InputAction @Click => m_Wrapper.m_Lobby_Click;
        /// <summary>
        /// Provides access to the underlying input action "Lobby/RightClick".
        /// </summary>
        public InputAction @RightClick => m_Wrapper.m_Lobby_RightClick;
        /// <summary>
        /// Provides access to the underlying input action "Lobby/MiddleClick".
        /// </summary>
        public InputAction @MiddleClick => m_Wrapper.m_Lobby_MiddleClick;
        /// <summary>
        /// Provides access to the underlying input action "Lobby/ScrollWheel".
        /// </summary>
        public InputAction @ScrollWheel => m_Wrapper.m_Lobby_ScrollWheel;
        /// <summary>
        /// Provides access to the underlying input action "Lobby/TrackedDevicePosition".
        /// </summary>
        public InputAction @TrackedDevicePosition => m_Wrapper.m_Lobby_TrackedDevicePosition;
        /// <summary>
        /// Provides access to the underlying input action "Lobby/TrackedDeviceOrientation".
        /// </summary>
        public InputAction @TrackedDeviceOrientation => m_Wrapper.m_Lobby_TrackedDeviceOrientation;
        /// <summary>
    ...
    private readonly InputAction m_Game_Voice;
    /// <summary>
    ...
    public struct GameActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Game/Voice".
        /// </summary>
        public InputAction @Voice => m_Wrapper.m_Game_Voice;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
