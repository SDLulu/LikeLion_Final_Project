...
namespace Stage
{
    ...
    { 
        ...
        static string spreadSheetID = "1XN_0uKrt1KFz8jBq5zBNT1N-u_Q9ssSPbexilJlsxrY"; // it is file id
...
/* Fields. */
		...
		public System.String CurrentStageName;
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("Stage"); 
            if (text != null)
            {
